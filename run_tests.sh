...
t 'echo'
# Bultin: export
t 'export lll=ooo -fdsfs=fds xxx=iii; echo $lll $fdsfs $xxx; export lll+=yo; echo $lll; export xxx; echo $xxx; export cc; echo $cc; export HELLO_WORLD=yo! ; echo $HELLO_WORLD; echo "$cc"'
# Builtin: unset
...
# Compare return values with bash
